...
for var in 1 3 5 7 10 12 15 18 21 28 35 43 50 70 120 200 800 1200 3000 5000 7000 13000 17000 25000 35000
    do
    counter=$((counter+1))
(       NS_GLOBAL_VALUE="RngRun=$var" ./waf --run fq-pie-10-up  	
) | tee -a ~/FQPIE/FQ-PIE-ns-3/ns3/Evaluation/FqPieTCP10/q.plotme
    mkdir ~/FqPieTCP10/$counter
    mkdir ~/FqPieTCP10/$counter/pcap
    mv ~/FQPIE/FQ-PIE-ns-3/ns3/Evaluation/FqPieTCP10/pcap ~/FqPieTCP10/$counter
    mv ~/FQPIE/FQ-PIE-ns-3/ns3/Evaluation/FqPieTCP10/q.plotme ~/FqPieTCP10/$counter
done
