...
int main (int argc, char *argv[])
{
  ...
  CommandLine cmd;
  cmd.AddValue ("queue_disc_type", "Queue disc type for gateway by defalut is CoDel (e.g. ns3::CoDelQueueDisc)", queue_disc_type);
  cmd.Parse (argc,argv);
  ...
  // Config::SetDefault ("ns3::CoDelQueueDisc::UseEcn", BooleanValue (useEcn));
