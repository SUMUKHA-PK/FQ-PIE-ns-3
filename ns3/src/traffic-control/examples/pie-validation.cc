...
int main (int argc, char *argv[])
{
  ...
  CommandLine cmd;
  cmd.AddValue ("queue_disc_type", "Queue disc type for gateway by defalut is Pie (e.g. ns3::PieQueueDisc)", queue_disc_type);
  cmd.Parse (argc,argv);
  ...
  // Config::SetDefault ("ns3::PieQueueDisc::UseEcn", BooleanValue (useEcn));
