...
CFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-fdebug-prefix-map==/usr/local/src/conda/-', '-fdebug-prefix-map==/usr/local/src/conda-prefix', '-fuse-linker-plugin', '-ffat-lto-objects', '-flto-partition=none', '-flto', '-flto', '-fuse-linker-plugin', '-ffat-lto-objects', '-flto-partition=none', '-fwrapv', '-O3']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-fdebug-prefix-map==/usr/local/src/conda/-', '-fdebug-prefix-map==/usr/local/src/conda-prefix', '-fuse-linker-plugin', '-ffat-lto-objects', '-flto-partition=none', '-flto', '-flto', '-fuse-linker-plugin', '-ffat-lto-objects', '-flto-partition=none', '-fwrapv', '-O3']
...
EXAMPLE_DIRECTORIES = ['naming', 'tcp', 'error-model', 'wireless', 'socket', 'realtime', 'stats', 'ipv6', 'tutorial', 'traffic-control', 'energy', 'matrix-topology', 'udp', 'routing', 'udp-client-server']
...
INCLUDES_PYEMBED = ['/home/some_guyy/anaconda3/include/python3.7m']
INFODIR = '/usr/local/share/info'
INT64X64_USE_128 = 1
LIBDIR = '/usr/local/lib'
LIBEXECDIR = '/usr/local/libexec'
LIBPATH_PYEMBED = ['/home/some_guyy/anaconda3/lib/python3.7/config-3.7m-x86_64-linux-gnu', '/home/some_guyy/anaconda3/lib']
LIBPATH_ST = '-L%s'
LIB_BOOST = []
LIB_PYEMBED = ['python3.7m', 'pthread', 'dl', 'util', 'rt', 'm', 'python3.7m', 'pthread', 'dl', 'util', 'rt', 'm']
LIB_RT = ['rt']
LIB_ST = '-l%s'
...
NS3_EXECUTABLE_PATH = ['/home/some_guyy/pk/git/1/FQ-PIE-ns-3/ns3/build/src/fd-net-device', '/home/some_guyy/pk/git/1/FQ-PIE-ns-3/ns3/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/home/some_guyy/pk/git/1/FQ-PIE-ns-3/ns3/build/lib']
...
PYO = 1
PYTAG = 'cpython-37'
PYTHON = ['/home/some_guyy/anaconda3/bin/python']
PYTHONARCHDIR = '/usr/local/lib/python3.7/site-packages'
PYTHONDIR = '/usr/local/lib/python3.7/site-packages'
PYTHON_CONFIG = ['/home/some_guyy/anaconda3/bin/python3.7-config']
PYTHON_VERSION = '3.7'
...
cfg_files = ['/home/some_guyy/pk/git/1/FQ-PIE-ns-3/ns3/build/ns3/config-store-config.h', '/home/some_guyy/pk/git/1/FQ-PIE-ns-3/ns3/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
